...
public class FlashMiniLobby {
    ...
    public FlashMiniLobby(final FlashRiskAdapter fra, final Risk myrisk, RootPaneContainer root, Frame window) {
        ...
        mlc = SwingMEWrapper.makeMiniLobbyClient(MiniLobbyClient.LOBBY_SERVER, myrisk, window, inGameChat, playerList);
    ...
    Component getOnlinePanel() {
        ...
        GameSidePanel sidePanel = new GameSidePanel(new JProgressBar(), new JButton(), playerList, inGameChat);
