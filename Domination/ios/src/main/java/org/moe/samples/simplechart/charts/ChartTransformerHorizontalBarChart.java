...
@ObjCClassBinding
public class ChartTransformerHorizontalBarChart extends ChartTransformer {
    static {
        NatJ.register();
    }

    @Generated
    protected ChartTransformerHorizontalBarChart(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ChartTransformerHorizontalBarChart init();

    @Generated
    @Selector("initWithViewPortHandler:")
    public native ChartTransformerHorizontalBarChart initWithViewPortHandler(
