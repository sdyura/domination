...
@ObjCClassName("_TtC6Charts19AnimatedViewPortJob")
@ObjCClassBinding
public class AnimatedViewPortJob extends ChartViewPortJob {
    static {
        NatJ.register();
    }

    @Generated
    protected AnimatedViewPortJob(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native AnimatedViewPortJob init();
