...
@ObjCClassName("_TtC6Charts23YAxisRendererRadarChart")
@ObjCClassBinding
public class YAxisRendererRadarChart extends ChartYAxisRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected YAxisRendererRadarChart(Pointer peer) {
        super(peer);
    }
    ...
    public native void computeAxisValuesWithMinMax(double yMin, double yMax);
