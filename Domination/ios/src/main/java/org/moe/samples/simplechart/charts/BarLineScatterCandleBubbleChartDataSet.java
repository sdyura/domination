...
@ObjCClassName("_TtC6Charts38BarLineScatterCandleBubbleChartDataSet")
@ObjCClassBinding
public class BarLineScatterCandleBubbleChartDataSet extends ChartDataSet implements
    ...
    @Generated
    protected BarLineScatterCandleBubbleChartDataSet(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native BarLineScatterCandleBubbleChartDataSet alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native BarLineScatterCandleBubbleChartDataSet allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native BarLineScatterCandleBubbleChartDataSet init();
    ...
    @Owned
    @Selector("new")
    public static native BarLineScatterCandleBubbleChartDataSet new_objc();
