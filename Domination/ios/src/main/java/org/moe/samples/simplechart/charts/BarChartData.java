...
public class BarChartData extends BarLineScatterCandleBubbleChartData {
    ...
    public static native BarChartData allocWithZone(VoidPtr zone);
    ...
    public native BarChartData initWithDataSet(@Mapped(ObjCObjectMapper.class) @Nullable IChartDataSet dataSet);

    @Generated
    @Selector("initWithDataSets:")
    public native BarChartData initWithDataSets(@Nullable NSArray<?> dataSets);
    ...
    @Owned
    @Selector("new")
    public static native BarChartData new_objc();
