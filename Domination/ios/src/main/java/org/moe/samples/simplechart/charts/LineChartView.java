...
@ObjCClassName("_TtC6Charts13LineChartView")
@ObjCClassBinding
public class LineChartView extends BarLineChartViewBase implements LineChartDataProvider {
    static {
        NatJ.register();
    }

    @Generated
    protected LineChartView(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native LineChartView alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native LineChartView allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native LineChartView init();
    ...
    public native LineChartView initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native LineChartView new_objc();
    ...
    @NotNull
    public static native LineChartView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    @NotNull
    public LineChartView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
