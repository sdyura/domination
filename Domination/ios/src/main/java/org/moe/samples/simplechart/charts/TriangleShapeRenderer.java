...
@ObjCClassName("_TtC6Charts21TriangleShapeRenderer")
@ObjCClassBinding
public class TriangleShapeRenderer extends NSObject implements IShapeRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected TriangleShapeRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native TriangleShapeRenderer alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native TriangleShapeRenderer allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native TriangleShapeRenderer init();
    ...
    @Owned
    @Selector("new")
    public static native TriangleShapeRenderer new_objc();
