...
@ObjCClassBinding
public class MoveChartViewJob extends ChartViewPortJob {
    static {
        NatJ.register();
    }

    @Generated
    protected MoveChartViewJob(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native MoveChartViewJob init();

    @Generated
    @Selector("initWithViewPortHandler:xValue:yValue:transformer:view:")
    public native MoveChartViewJob initWithViewPortHandlerXValueYValueTransformerView(
