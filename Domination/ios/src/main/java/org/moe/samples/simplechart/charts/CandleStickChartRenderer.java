...
@ObjCClassName("_TtC6Charts24CandleStickChartRenderer")
@ObjCClassBinding
public class CandleStickChartRenderer extends LineScatterCandleRadarChartRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected CandleStickChartRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CandleStickChartRenderer init();
