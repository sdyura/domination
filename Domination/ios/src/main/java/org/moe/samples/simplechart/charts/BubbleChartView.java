...
@ObjCClassName("_TtC6Charts15BubbleChartView")
@ObjCClassBinding
public class BubbleChartView extends BarLineChartViewBase implements BubbleChartDataProvider {
    static {
        NatJ.register();
    }

    @Generated
    protected BubbleChartView(Pointer peer) {
        super(peer);
    }
    ...
    @NotNull
    public static native BubbleChartView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    @NotNull
    public BubbleChartView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    @NotNull
    public static native BubbleChartView appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    @NotNull
    public BubbleChartView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) @Nullable UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    @NotNull
    public static native BubbleChartView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<?> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    @NotNull
    public BubbleChartView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<?> containerTypes) {
    ...
    @NotNull
    public BubbleChartView _appearanceWhenContainedIn(
            @Mapped(ObjCObjectMapper.class) @Nullable UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    @NotNull
    public static native BubbleChartView appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    @NotNull
    public BubbleChartView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native BubbleChartView init();

    @Generated
    @Selector("initWithCoder:")
    public native BubbleChartView initWithCoder(@NotNull NSCoder aDecoder);
