...
public class BubbleChartView extends BarLineChartViewBase implements BubbleChartDataProvider {
    ...
    @NotNull
    public static native BubbleChartView appearanceWhenContainedInInstancesOfClasses(
            @NotNull NSArray<? extends Class> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    @NotNull
    public BubbleChartView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<? extends Class> containerTypes) {
