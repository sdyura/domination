...
@ObjCClassBinding
public class LineRadarChartRenderer extends LineScatterCandleRadarChartRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected LineRadarChartRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native LineRadarChartRenderer init();
