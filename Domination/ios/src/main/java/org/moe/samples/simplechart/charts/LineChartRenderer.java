...
@ObjCClassName("_TtC6Charts17LineChartRenderer")
@ObjCClassBinding
public class LineChartRenderer extends LineRadarChartRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected LineChartRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native LineChartRenderer init();
