...
@ObjCClassName("_TtC6Charts18CrossShapeRenderer")
@ObjCClassBinding
public class CrossShapeRenderer extends NSObject implements IShapeRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected CrossShapeRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CrossShapeRenderer alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CrossShapeRenderer allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CrossShapeRenderer init();
    ...
    @Owned
    @Selector("new")
    public static native CrossShapeRenderer new_objc();
