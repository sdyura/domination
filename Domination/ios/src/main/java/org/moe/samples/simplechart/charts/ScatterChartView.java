...
@ObjCClassName("_TtC6Charts16ScatterChartView")
@ObjCClassBinding
public class ScatterChartView extends BarLineChartViewBase implements ScatterChartDataProvider {
    static {
        NatJ.register();
    }

    @Generated
    protected ScatterChartView(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ScatterChartView alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ScatterChartView allocWithZone(VoidPtr zone);
    ...
    @Selector("appearance")
    @NotNull
    public static native ScatterChartView appearance();

    @Generated
    @ProtocolClassMethod("appearance")
    @NotNull
    public ScatterChartView _appearance() {
        return appearance();
    }
    ...
    @NotNull
    public static native ScatterChartView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    @NotNull
    public ScatterChartView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    @NotNull
    public static native ScatterChartView appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    @NotNull
    public ScatterChartView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) @Nullable UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    @NotNull
    public static native ScatterChartView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<?> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    @NotNull
    public ScatterChartView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<?> containerTypes) {
    ...
    @NotNull
    public static native ScatterChartView appearanceWhenContainedIn(
            @Mapped(ObjCObjectMapper.class) @Nullable UIAppearanceContainer ContainerClass, Object... varargs);
    ...
    @NotNull
    public ScatterChartView _appearanceWhenContainedIn(
            @Mapped(ObjCObjectMapper.class) @Nullable UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    @NotNull
    public static native ScatterChartView appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    @NotNull
    public ScatterChartView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
    ...
    @Generated
    @Selector("init")
    public native ScatterChartView init();

    @Generated
    @Selector("initWithCoder:")
    public native ScatterChartView initWithCoder(@NotNull NSCoder aDecoder);

    @Generated
    @Selector("initWithFrame:")
    public native ScatterChartView initWithFrame(@ByValue CGRect frame);
    ...
    @Owned
    @Selector("new")
    public static native ScatterChartView new_objc();
