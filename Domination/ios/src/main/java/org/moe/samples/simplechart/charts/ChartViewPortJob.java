...
@ObjCClassBinding
public class ChartViewPortJob extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ChartViewPortJob(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ChartViewPortJob init();

    @Generated
    @Selector("initWithViewPortHandler:xValue:yValue:transformer:view:")
    public native ChartViewPortJob initWithViewPortHandlerXValueYValueTransformerView(
