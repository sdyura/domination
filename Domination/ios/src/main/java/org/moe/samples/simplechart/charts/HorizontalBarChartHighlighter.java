...
@ObjCClassBinding
public class HorizontalBarChartHighlighter extends BarChartHighlighter {
    static {
        NatJ.register();
    }

    @Generated
    protected HorizontalBarChartHighlighter(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native HorizontalBarChartHighlighter init();

    @Generated
    @Selector("initWithChart:")
    public native HorizontalBarChartHighlighter initWithChart(@Mapped(ObjCObjectMapper.class) @NotNull Object chart);
