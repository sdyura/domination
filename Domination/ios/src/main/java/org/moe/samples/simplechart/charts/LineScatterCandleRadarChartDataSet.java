...
public class LineScatterCandleRadarChartDataSet extends BarLineScatterCandleBubbleChartDataSet implements
    ...
    public static native LineScatterCandleRadarChartDataSet allocWithZone(VoidPtr zone);
    ...
    public native LineScatterCandleRadarChartDataSet initWithEntries(@Nullable NSArray<? extends ChartDataEntry> entries);

    @Generated
    @Selector("initWithEntries:label:")
    public native LineScatterCandleRadarChartDataSet initWithEntriesLabel(
            @Nullable NSArray<? extends ChartDataEntry> entries, @Nullable String label);

    @Generated
    @Selector("initWithLabel:")
    public native LineScatterCandleRadarChartDataSet initWithLabel(@Nullable String label);
    ...
    @Owned
    @Selector("new")
    public static native LineScatterCandleRadarChartDataSet new_objc();
