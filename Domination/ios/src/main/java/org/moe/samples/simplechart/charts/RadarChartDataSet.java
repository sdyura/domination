...
public class RadarChartDataSet extends LineRadarChartDataSet implements IRadarChartDataSet {
    ...
    public native RadarChartDataSet initWithEntries(@Nullable NSArray<? extends ChartDataEntry> entries);

    @Generated
    @Selector("initWithEntries:label:")
    public native RadarChartDataSet initWithEntriesLabel(@Nullable NSArray<? extends ChartDataEntry> entries,
            @Nullable String label);

    @Generated
    @Selector("initWithLabel:")
    public native RadarChartDataSet initWithLabel(@Nullable String label);
    ...
    public native void setHighlightCircleFillColor(@Nullable UIColor value);
    ...
    public native void setHighlightCircleStrokeColor(@Nullable UIColor value);
