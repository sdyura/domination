...
@ObjCClassName("_TtC6Charts22ChevronUpShapeRenderer")
@ObjCClassBinding
public class ChevronUpShapeRenderer extends NSObject implements IShapeRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected ChevronUpShapeRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native ChevronUpShapeRenderer alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native ChevronUpShapeRenderer allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native ChevronUpShapeRenderer init();
    ...
    @Owned
    @Selector("new")
    public static native ChevronUpShapeRenderer new_objc();
