...
@ObjCClassBinding
public class CombinedChartHighlighter extends ChartHighlighter {
    static {
        NatJ.register();
    }

    @Generated
    protected CombinedChartHighlighter(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native CombinedChartHighlighter init();
