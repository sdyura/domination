...
@ObjCClassName("_TtC6Charts18CandleChartDataSet")
@ObjCClassBinding
public class CandleChartDataSet extends LineScatterCandleRadarChartDataSet implements ICandleChartDataSet {
    static {
        NatJ.register();
    }

    @Generated
    protected CandleChartDataSet(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CandleChartDataSet alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CandleChartDataSet allocWithZone(VoidPtr zone);
    ...
    @Nullable
    public native UIColor decreasingColor();
    ...
    @Nullable
    public native UIColor increasingColor();
    ...
    @Generated
    @Selector("init")
    public native CandleChartDataSet init();

    @Generated
    @Selector("initWithEntries:")
    public native CandleChartDataSet initWithEntries(@Nullable NSArray<? extends ChartDataEntry> entries);

    @Generated
    @Selector("initWithEntries:label:")
    public native CandleChartDataSet initWithEntriesLabel(@Nullable NSArray<? extends ChartDataEntry> entries,
            @Nullable String label);

    @Generated
    @Selector("initWithLabel:")
    public native CandleChartDataSet initWithLabel(@Nullable String label);
    ...
    @Nullable
    public native UIColor neutralColor();

    @Generated
    @Owned
    @Selector("new")
    public static native CandleChartDataSet new_objc();
    ...
    public native void setBarSpace(double value);
    ...
    public native void setDecreasingColor(@Nullable UIColor value);

    @Generated
    @Selector("setDecreasingFilled:")
    public native void setDecreasingFilled(boolean value);
    ...
    public native void setIncreasingColor(@Nullable UIColor value);

    @Generated
    @Selector("setIncreasingFilled:")
    public native void setIncreasingFilled(boolean value);

    @Generated
    @Selector("setNeutralColor:")
    public native void setNeutralColor(@Nullable UIColor value);
    ...
    public native void setShadowColorSameAsCandle(boolean value);

    @Generated
    @Selector("setShadowWidth:")
    public native void setShadowWidth(double value);

    @Generated
    @Selector("setShowCandleBar:")
    public native void setShowCandleBar(boolean value);
    ...
    public native double shadowWidth();

    @Generated
    @Selector("showCandleBar")
    public native boolean showCandleBar();
