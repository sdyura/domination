...
@ObjCClassName("_TtC6Charts13LineChartData")
@ObjCClassBinding
public class LineChartData extends ChartData {
    ...
    @Generated
    protected LineChartData(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native LineChartData init();

    @Generated
    @Selector("initWithDataSet:")
    public native LineChartData initWithDataSet(@Mapped(ObjCObjectMapper.class) @Nullable IChartDataSet dataSet);

    @Generated
    @Selector("initWithDataSets:")
    public native LineChartData initWithDataSets(@Nullable NSArray<?> dataSets);
