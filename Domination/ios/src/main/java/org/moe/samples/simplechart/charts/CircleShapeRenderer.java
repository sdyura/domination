...
@ObjCClassName("_TtC6Charts19CircleShapeRenderer")
@ObjCClassBinding
public class CircleShapeRenderer extends NSObject implements IShapeRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected CircleShapeRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native CircleShapeRenderer alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native CircleShapeRenderer allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native CircleShapeRenderer init();
    ...
    @Owned
    @Selector("new")
    public static native CircleShapeRenderer new_objc();
