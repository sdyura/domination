...
@ObjCClassName("_TtC6Charts19ChartColorTemplates")
@ObjCClassBinding
public class ChartColorTemplates extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected ChartColorTemplates(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ChartColorTemplates init();
