...
@ObjCClassName("_TtC6Charts14XShapeRenderer")
@ObjCClassBinding
public class XShapeRenderer extends NSObject implements IShapeRenderer {
    static {
        NatJ.register();
    }

    @Generated
    protected XShapeRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native XShapeRenderer alloc();

    @Generated
    @Owned
    @Selector("allocWithZone:")
    public static native XShapeRenderer allocWithZone(VoidPtr zone);
    ...
    @Generated
    @Selector("init")
    public native XShapeRenderer init();
    ...
    @Owned
    @Selector("new")
    public static native XShapeRenderer new_objc();
