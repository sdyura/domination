...
public class LineRadarChartDataSet extends LineScatterCandleRadarChartDataSet implements ILineRadarChartDataSet {
    ...
    @Generated
    protected LineRadarChartDataSet(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native LineRadarChartDataSet init();

    @Generated
    @Selector("initWithEntries:")
    public native LineRadarChartDataSet initWithEntries(@Nullable NSArray<? extends ChartDataEntry> entries);

    @Generated
    @Selector("initWithEntries:label:")
    public native LineRadarChartDataSet initWithEntriesLabel(@Nullable NSArray<? extends ChartDataEntry> entries,
            @Nullable String label);

    @Generated
    @Selector("initWithLabel:")
    public native LineRadarChartDataSet initWithLabel(@Nullable String label);
