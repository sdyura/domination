...
@ObjCClassName("_TtC6Charts15BubbleChartData")
@ObjCClassBinding
public class BubbleChartData extends BarLineScatterCandleBubbleChartData {
    static {
        NatJ.register();
    }

    @Generated
    protected BubbleChartData(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native BubbleChartData init();

    @Generated
    @Selector("initWithDataSet:")
    public native BubbleChartData initWithDataSet(@Mapped(ObjCObjectMapper.class) @Nullable IChartDataSet dataSet);

    @Generated
    @Selector("initWithDataSets:")
    public native BubbleChartData initWithDataSets(@Nullable NSArray<?> dataSets);
