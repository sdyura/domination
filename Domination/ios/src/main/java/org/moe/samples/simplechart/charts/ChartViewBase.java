...
public class ChartViewBase extends NSUIView implements ChartAnimatorDelegate, ChartDataProvider {
    ...
    public native void highlightValueWithXYDataSetIndexDataIndex(double x, double y, long dataSetIndex, long dataIndex);
    ...
    public native void highlightValueWithXYDataSetIndexDataIndexCallDelegate(double x, double y, long dataSetIndex,
            long dataIndex, boolean callDelegate);
    ...
    public native void setExtraOffsetsWithLeftTopRightBottom(double left, double top, double right, double bottom);
