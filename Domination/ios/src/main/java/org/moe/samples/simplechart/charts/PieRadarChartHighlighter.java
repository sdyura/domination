...
@ObjCClassBinding
public class PieRadarChartHighlighter extends ChartHighlighter {
    static {
        NatJ.register();
    }

    @Generated
    protected PieRadarChartHighlighter(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native PieRadarChartHighlighter init();
