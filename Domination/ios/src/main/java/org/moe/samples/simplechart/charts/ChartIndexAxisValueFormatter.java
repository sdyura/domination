...
public class ChartIndexAxisValueFormatter extends NSObject implements IChartAxisValueFormatter {
    ...
    @Generated
    protected ChartIndexAxisValueFormatter(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native ChartIndexAxisValueFormatter init();

    @Generated
    @Selector("initWithValues:")
    public native ChartIndexAxisValueFormatter initWithValues(@NotNull NSArray<String> values);
    ...
    @Generated
    @Selector("setValues:")
    public native void setValues(@NotNull NSArray<String> value);
    ...
    @Selector("withValues:")
    @Nullable
    public static native ChartIndexAxisValueFormatter withValues(@NotNull NSArray<String> values);
}