...
public class BarChartView extends BarLineChartViewBase implements BarChartDataProvider {
    ...
    @NotNull
    public static native BarChartView appearanceForTraitCollection(@NotNull UITraitCollection trait);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollection")
    @NotNull
    public BarChartView _appearanceForTraitCollection(@NotNull UITraitCollection trait) {
    ...
    @NotNull
    public static native BarChartView appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
    ...
    @NotNull
    public BarChartView _appearanceForTraitCollectionWhenContainedIn(@NotNull UITraitCollection trait,
            @Mapped(ObjCObjectMapper.class) @Nullable UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    @NotNull
    public static native BarChartView appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<?> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceForTraitCollectionWhenContainedInInstancesOfClasses")
    @NotNull
    public BarChartView _appearanceForTraitCollectionWhenContainedInInstancesOfClasses(
            @NotNull UITraitCollection trait, @NotNull NSArray<?> containerTypes) {
    ...
    @NotNull
    public BarChartView _appearanceWhenContainedIn(
            @Mapped(ObjCObjectMapper.class) @Nullable UIAppearanceContainer ContainerClass, Object... varargs) {
    ...
    @NotNull
    public static native BarChartView appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes);

    @Generated
    @ProtocolClassMethod("appearanceWhenContainedInInstancesOfClasses")
    @NotNull
    public BarChartView _appearanceWhenContainedInInstancesOfClasses(@NotNull NSArray<?> containerTypes) {
    ...
    @ByValue
    public native CGRect getBarBoundsWithEntry(@NotNull BarChartDataEntry e);
    ...
    public native void highlightValueWithXDataSetIndexStackIndex(double x, long dataSetIndex, long stackIndex);
    ...
    public native BarChartView initWithCoder(@NotNull NSCoder aDecoder);
