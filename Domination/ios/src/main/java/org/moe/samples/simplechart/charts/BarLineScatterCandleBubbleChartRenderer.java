...
public class BarLineScatterCandleBubbleChartRenderer extends ChartDataRendererBase {
    ...
    @Generated
    protected BarLineScatterCandleBubbleChartRenderer(Pointer peer) {
        super(peer);
    }
    ...
    @Generated
    @Selector("init")
    public native BarLineScatterCandleBubbleChartRenderer init();
    ...
    public native BarLineScatterCandleBubbleChartRenderer initWithAnimatorViewPortHandler(
            @NotNull ChartAnimator animator, @NotNull ChartViewPortHandler viewPortHandler);

    @Generated
    @Selector("initWithViewPortHandler:")
    public native BarLineScatterCandleBubbleChartRenderer initWithViewPortHandler(
